...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝  ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://MoviwsMagaa")]]), disable_web_page_preview=True
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer(script.SPELL_CHECK.format(query.from_user.first_name), show_alert=True)
